...
const getRetard = async function (req, res, next) {
  ...
  for (let index = 0; index < liste.length; index++) {
    ...
    for (let index2 = 0; index2 < liste_mois_2.length; index2++) {
      ...
      var sql_data = "select mois,retard_livraison from bilan_projet where annee = '" + annee + "' and id_ligne = '" + id_ligne + "'  and mois = '" + periode + "' and id_plan = '" + id_plan + "' order by libelle_plan";
